...
document.querySelectorAll('.wellness-product-layout, .sermorelin-quality, .sermorelin-benefits, .glutathione-quality, .nad-benefits, .nad-quality, .mic-b12-benefits, .mic-b12-quality, .tesamorelin-benefits, .tesamorelin-quality').forEach((layout) => {
  const details = layout.querySelector('.wellness-product-details, .sermorelin-quality-content, .sermorelin-benefits-copy, .glutathione-quality-content, .nad-benefits-copy, .nad-quality-content, .mic-b12-benefits-copy, .mic-b12-quality-content, .tesamorelin-benefits-copy, .tesamorelin-quality-content');
